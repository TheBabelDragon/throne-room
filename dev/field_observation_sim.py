#!/usr/bin/env python3
"""
DEV ONLY — synthetic FieldObservation generator.

This is NOT part of the operational Throne Room path.
It does not represent taken measurements.
Use only for UI / ingest plumbing tests.

Operational observation comes from real bodies:
  optical-body-s3, echo-grid, hall-node, zvs-node, etc.
"""
...
def generate_optical(body_id: str = "optical-01") -> Iterator[FieldObservation]:
    ...
    while True:
        ...
        yield FieldObservation(
            ...
            confidence=0.95,
            meta={"source": "synthetic", "dev_only": True},
        )
        t += 0.15
        time.sleep(0.12)
...
def run_simulator(output: Path | None = None, duration_s: float | None = None) -> None:
    generators = [
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="DEV ONLY synthetic FieldObservation generator — not operational"
    )
